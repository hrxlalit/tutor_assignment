...
RSpec.describe Course, type: :model do
  describe "Validations" do
    ...
    it "is not valid with description" do
      expect(Course.new(description: "Ruby on Rails")).to_not be_valid
    end

    it "is not valid with name and description" do
      expect(Course.new(name: "Ruby on Rails", description: "Ruby on Rails is good for project development.")).to be_valid
    end
